...
// THEORY OF FUNCTION OVER RIDING
...
member function which exists in both classes (base and
derived), the member function of the derived class IS
invoked and the function of the base class is ignored.
